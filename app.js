...
function sumAndMultiply(a,b,c){ //eslint-disable-line
  ...
  var message1 = (a + ' and ' + b + ' and ' + c + ' sum to ' + addition + '.');
  var multiplication = multiply(a,multiply(b,c)[0])[0];
  var message2 = ('The product of ' + a + ' and ' + b + ' and ' + c + ' is ' + multiplication + '.');
  return [addition,multiplication,message1,message2];
}
...
function sumArray(testArray){
  ...
  for(var i = 0; i < testArray.length; i++){
    totalSum = sum(testArray[i],totalSum)[0];
  ...
  return [totalSum,(stringNums + ' was passed in as an array of numbers, and '+ totalSum + ' is their sum.')];
}
